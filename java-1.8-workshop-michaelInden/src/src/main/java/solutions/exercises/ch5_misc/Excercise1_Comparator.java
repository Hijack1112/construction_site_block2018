package src.main.java.solutions.exercises.ch5_misc;
...
public class Excercise1_Comparator 
{
	...
	{	
		...
		final Comparator<String> byLength2 = null;    	// TODO
		Collections.sort(names2, byLength2);
		System.out.println(names2);
		
		// Combination of Comparators
		final Comparator<String> byLengthThenNatural = null;    	// TODO
		Collections.sort(names2, byLengthThenNatural);
		System.out.println(names2);
				
		final Comparator<String> byLengthReversedThenNatural = null;    	// TODO
